...
import { subscribe, getConversations, getMessages, sendMessage, ensureDirect, CURRENT_USER } from '../store/chatStore'
...
export function useChat() {
  ...
  return { conversations, messagesByConv, send: sendMessage, ensureDirect, me: CURRENT_USER }
}
