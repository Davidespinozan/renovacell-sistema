...
import { Calendario } from './design/Calendario'
import { Promociones } from './design/Promociones'
import { BibliotecaFichas } from './design/BibliotecaFichas'
...
const SCREENS: Record<string, () => React.ReactNode> = {
  ...
  dis_cal: () => <Calendario />,
  dis_promos: () => <Promociones />,
  dis_lib: () => <BibliotecaFichas />,
  caja: () => <Caja />,
  vev: () => <VentasEvento />,
}
